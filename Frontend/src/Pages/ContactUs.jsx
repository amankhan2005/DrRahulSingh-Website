...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            >
              <div className="text-2xl lg:text-3xl font-bold flex items-center text-white">
                <FaLocationDot className="mr-3 text-3xl lg:text-4xl" /> Our
                Location
              </div>
            ...
            <div className="bg-primary rounded-xl p-6 shadow-lg hover:shadow-xl transition duration-300">
              <div className="text-2xl lg:text-3xl font-bold flex items-center text-white">
                <FaPhone className="mr-3 text-3xl lg:text-4xl rotate-90" />{" "}
                Connect with Us
              </div>
      ...
      {/* Google Map */}
      <div className=" mx-auto px-4 md:px-8 lg:px-16 mt-10 lg:mt-16 rounded-lg shadow-lg overflow-hidden">
        <iframe
