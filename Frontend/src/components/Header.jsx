...
export default function Header() {
  ...
  >
    ...
    <div className="flex text-gray-100 justify-around items-center py-2 bg-primary md:text-lg text-sm px-2">
      <a href="https://facebook.com" className="hover:text-gray-50" title="Facebook"><i className="fab fa-facebook-f"></i></a>
      <a href="https://twitter.com" className="hover:text-gray-50" title="Twitter"><FaXTwitter /></a>
      <a href="https://instagram.com" className="hover:text-gray-50" title="Instagram"><i className="fab fa-instagram"></i></a>
      <a href="https://youtube.com" className="hover:text-gray-50" title="YouTube"><i className="fab fa-youtube"></i></a>
      <a href="https://linkedin.com" className="hover:text-gray-50" title="LinkedIn"><i className="fab fa-linkedin-in"></i></a>
      <a href="https://plus.google.com" className="hover:text-gray-50" title="Google Plus"><i className="fab fa-google-plus-g"></i></a>
    </div>
    ...
    <ul className="text-gray-800 font-semibold space-y-4 px-2 ps-6 mt-5">
      {/* Home */}
      <li className={`${location.pathname === "/" ? "text-primary" : ""}`}>
      ...
      <li className="relative">
        ...
        {openDropdown === "about" && (
          <ul className="block bg-white shadow-md rounded-md py-2 w-full text-sm">
            <li>
              <Link to="/about" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                About LandMark Hospital
              </Link>
            </li>
            <li>
              <Link to="/our-team" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
      ...
      <li className="relative">
        ...
        {openDropdown === "specialities" && (
          <ul className="block bg-white shadow-md rounded-md py-2 w-full text-sm">
            <li>
              <Link to="/brain" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                Brain Surgery
              </Link>
            </li>
            <li>
              <Link to="/spine" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                Spine Surgery
              </Link>
            </li>
            <li>
              <Link to="/peripheral-nerve-surgery" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
      ...
      {/* Facilities */}
      <li className={`${location.pathname === "/facilities" ? "text-primary" : ""}`}>
        <Link to="/facilities" onClick={() => setIsMobileMenuOpen(false)}>Facilities</Link>
      </li>

      {/* Cases */}
      <li className={`${location.pathname === "/cases" ? "text-primary" : ""}`}>
        <Link to="/cases" onClick={() => setIsMobileMenuOpen(false)}>Cases</Link>
      </li>

      {/* Blog */}
      <li className={`${location.pathname.startsWith("/blog") ? "text-primary" : ""}`}>
      ...
      <li className="relative">
        ...
        {openDropdown === "gallery" && (
          <ul className="block bg-white shadow-md rounded-md py-2 w-full text-sm">
            <li>
              <Link to="/gallery?tab=photo" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                Photo Gallery
              </Link>
            </li>
            <li>
              <Link to="/gallery?tab=video" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                Video Gallery
              </Link>
            </li>
            <li>
              <Link to="/gallery?tab=news" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                News & Media
              </Link>
            </li>
            <li>
              <Link to="/gallery?tab=rewards" className="block px-4 py-2 hover:bg-blue-100" onClick={() => setIsMobileMenuOpen(false)}>
                Rewards & Recognition
              </Link>
            </li>
          </ul>
      ...
      {/* Testimonials */}
      <li className={`${location.pathname === "/testimonials" ? "text-primary" : ""}`}>
        <Link to="/testimonials" onClick={() => setIsMobileMenuOpen(false)}>Testimonials</Link>
      </li>

      {/* Contact */}
      <li className={`${location.pathname === "/contact" ? "text-primary" : ""}`}>
