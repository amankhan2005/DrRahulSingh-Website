        ...
        <div className="flex flex-col md:flex-row gap-10 items-stretch">
          ...
          <div className="w-full md:w-1/2 h-full">
            <img
              ...
              alt="Dr. Rahul Singh - Best Brain and Spine Surgeon in Lucknow"
              className="w-full h-150 object-cover object-top rounded-xl shadow-lg"
              loading="lazy"
              width="600"
              height="800"
            />
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-600">
              Leading <span className="font-bold">Brain & Spine Surgeon</span> in{" "}
            ...
            <p className="text-gray-600 mb-3 leading-relaxed text-sm sm:text-base font-medium">
              ...
              <span className="font-bold">neurosurgery, spine surgery</span>, and{" "}
              <span className="font-bold">peripheral nerve care</span>. He
              completed his{" "}
            ...
            {/* Memberships */}
            <div className="mb-2">
              <h4 className="text-base sm:text-lg font-bold mb-3 text-primary">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button
                ...
                aria-label="Book Appointment with Dr. Rahul Singh"
              >
              ...
              <div className="flex items-center">
                <div
                  ...
                  bg-gradient-to-r from-[#13335b] to-[#3b628b] shadow-md 
                  hover:scale-105 hover:shadow-xl transition-transform duration-300"
                >
                  <a
                    href="tel:+918400136465"
                    aria-label="Call Dr. Rahul Singh at +91 8400136465"
                  >
